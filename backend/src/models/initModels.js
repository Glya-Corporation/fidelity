const { Users, Categories, Products, Register, Business, Roles, Inventary } = require('./index');
...
const initModels = () => {
  ...
  Business.hasMany(Inventary, { as: 'inventary', foreignKey: 'business_id' });
  Inventary.belongsTo(Business, { as: 'business', foreignKey: 'business_id' });
};
