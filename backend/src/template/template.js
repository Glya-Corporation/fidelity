                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class=""
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                <span style="font-size:42px;">Bienvenido a Fidelity.</span></p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                    ...
                                                                    <div style="font-family: sans-serif">
                                                                        <div class=""
                                                                            ...
                                                                            <p style="margin: 0; font-size: 16px; text-align: left; mso-line-height-alt: 24px;">
                                                                                <span style="font-size:16px;">Hola, <b>${data.name} ${data.surname}</b></span>
                                                                            </p>
                                                                            </br>
                                                                            <p style="margin: 0; text-align: left; font-size: 16px; mso-line-height-alt: 24px;">
                                                                              Es un placer darte la más cordial bienvenida a <b>Pulpo Marinero</b>, tu nuevo destino para experiencias excepcionales. Estamos encantados de tenerte como parte de nuestra familia y agradecemos sinceramente tu elección.
                                                                    ...
                                                                    <div style="font-family: sans-serif">
                                                                        <div class=""
                                                                            ...
                                                                            <p style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 18px;">
                                                                                <span style="font-size:12px;">Cuenca, Azuay EC.</span>
                                                                            </p>
                                                                            <p style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 18px;">
                                                                                <a href="mailto:corporationglya@gmail.com" target="_blank" style="font-size:12px; color:#fff;text-decoration: none;">corporationglya@gmail.com</a>
                                                                            </p>
                                                                            <p style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 18px;">
                                                                                <a href="https://wa.me/message/COOCPNAKZIM3G1?src=qr" target="_blank" style="font-size:12px; color: #fff;">(+593) 97 901 0717</a>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                </td>
